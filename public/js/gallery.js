...
function onModal(idx) {
	...
	$.get('/gallery/view/'+id, function(r){
		...
		$(".modal-wrapper").find(".def-img").stop().show(0);
		$(".modal-wrapper").find(".hover-img").stop().hide(0);
		$(".modal-wrapper").find(".modal-pager > i").removeClass("active");
		$(".modal-wrapper .bt-def").addClass("active");
...
$(".modal-wrapper .bt-def").click(onBtDefClick).trigger("click");
function onBtDefClick() {
	$(".modal-wrapper").find(".def-img").stop().show(500);
	$(".modal-wrapper").find(".hover-img").stop().hide(500);
	$(".modal-wrapper").find(".modal-pager > i").removeClass("active");
	$(this).addClass("active");
	seq = "";
}

$(".modal-wrapper .bt-hover").click(onBtHoverCilck);
function onBtHoverCilck() {
	$(".modal-wrapper").find(".def-img").stop().hide(500);
	$(".modal-wrapper").find(".hover-img").stop().show(500);
	$(".modal-wrapper").find(".modal-pager > i").removeClass("active");
	$(this).addClass("active");
	seq = "2";
}
